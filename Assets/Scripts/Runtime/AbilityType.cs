namespace WitsAndFools
{
    ...
    public static class AbilityTypeExtensions
    {
        public static string DisplayName(this AbilityType a) => a switch
        {
            ...
            AbilityType.HeavyHand => "Heavy Hand",
        ...
        public static string Description(this AbilityType a) => a switch
        {
            ...
            AbilityType.TrapCard => "Spend 1 Favor. Draw 1 card and bury opponent's weakest card to the bottom of their deck.",
            ...
            AbilityType.Conquer => "Spend 1 Fury. This card attacks with +2 rank.",
            AbilityType.HeavyHand => "If you hold more cards than your opponent, this card attacks with +2 rank.",
            ...
            AbilityType.StackTheDeck => "Draw 2 cards, then choose 1 to put on top of your deck.",
